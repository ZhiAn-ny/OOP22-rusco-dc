...
public interface RoomFactory {
    ...
    /**
     * Creates an empty square <code>Room</code> of the specified size.
     * @param size the side of the square
     * @return a square room
     */
    Room emptySquareRoom(int size);

    /**
     * Creates an empty <code>Room</code> in the shape of a rectangle.
     ...
     */
    Room emptyRectangleRoom(int width, int height);

    /**
     * Creates a randomly generated <code>Room</code> with no trap tiles.
